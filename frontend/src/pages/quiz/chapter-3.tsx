/**
 * Quiz page for Chapter 3: Sensors and Actuators.
 */
...
const CHAPTER_ID = 'chapter-3';
const CHAPTER_TITLE = 'Sensors and Actuators';

export default function Chapter3QuizPage(): JSX.Element {
  return (
    <Layout
